...
public class Constants {
    ...
    public static List<String> expectedFeatures = List.of("Vuln Discovery  You can’t fix what you can’t find.", " Vuln Prioritisation Focus on risks that have real potential for exploitation", "Vuln Remediation Don’t just find your flaws, fix them.", "Automation Threats don’t take time off, but you can.");
